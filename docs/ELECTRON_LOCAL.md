...
Ademas Electron abre un WebSocket contra `wss://tu-app.onrender.com/ws/sync/`. Si alguien cambia datos desde la web en Render, Render envia un aviso y Electron ejecuta la sincronizacion inmediatamente. Si el WebSocket se corta, se reconecta solo.
